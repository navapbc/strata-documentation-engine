...
| strata-sdk-case-management | sdk-typescript | https://github.com/navapbc/strata-sdk-case-management | main | docs sdk skills tools | TypeScript case-management SDK monorepo (sdk/core, sdk/types, sdk/config-schema, sdk/case-management-blueprints); discovery-mode repo, distill docs/ + package READMEs + skills/ + tools/workflow-viewer, verify against sdk/; not the Rails SDK, feature_keys stay empty |
